   ...
   <tr>
         ...
         <td valign="top" class="preheaderContent">
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
           <tr>
            ...
            <span style="font-size:12px">Click here to see on website<br/><a href="http://aseanyouth.net" target="_blank">OPEN WEBSITE</a></span>
             </div>
	          </td>
            <td valign="middle" width="600" align="center">
             <div mc:edit="std_preheader_links">
    ...
    <tr>
     <td align="center" valign="top" bgcolor="#FFFFFF">
      <h2 class="h4"><span style="font-size:12px">Greeting from ASEAN Youth Organization!
...
We would like to invite your school to participate in this competition by sending your students. There will be several competitions such as Wall magazine, Speech contest, Story telling, Essay writing, and News report competition.</h2>
